 ...
 */,
  ...
  U.add(t);const n = i ? i.element : document.createElement("template"),
    ...
    switch (e) {case Boolean:
      ...
      Y = (t, e) => e !== t && (e == e || t == t),
      W = { attribute: !0, type: String, converter: z, reflect: !1, hasChanged: Y };class B extends HTMLElement {
  constructor() {
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions || (window.litElementVersions = [])).push("2.3.1");const Q = {};class tt extends B {
  static getStyles() {
    return this.styles;
...
class rt {
  ...
  n = n || {}, i = null == i ? {} : i;const s = new Event(e, { bubbles: void 0 === n.bubbles || n.bubbles, cancelable: Boolean(n.cancelable), composed: void 0 === n.composed || n.composed });return s.detail = i, t.dispatchEvent(s), s;
      ...
      Yt = "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0;class Wt extends HTMLElement {
  constructor() {
...
}customElements.define("button-card-action-handler", Wt);const Bt = (t, e) => {
  const i = (() => {
  ...
  var e = { r: 0, g: 0, b: 0 },
    ...
    var n, s, r;if (t = Jt(t, 360), e = Jt(e, 100), i = Jt(i, 100), 0 === e) s = i, r = i, n = i;else {
...
});console.info("%c  BUTTON-CARD  \n%c Version 3.3.0-0 ", "color: orange; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray");let ke = class extends tt {
  constructor() {
    ...
    if (super.connectedCallback(), this._config && this._config.entity && "timer" === ge(this._config.entity)) {
    ...
    const t = this._getMatchingConfigState(this._stateObj),
      ...
      <div id="aspect-ratio" style=${it(r)}>
        <ha-card
          ...
          .actionHandler=${Gt({ hasDoubleClick: "none" !== this._config.double_tap_action.action, hasHold: "none" !== this._config.hold_action.action, repeat: this._config.hold_action.repeat })}
          .config="${this._config}"
        >
    ...
    return this._config.lock && this._getTemplateOrValue(this._stateObj, this._config.lock.enabled) ? R`
        <div
          ...
          .actionHandler=${Gt({ hasDoubleClick: "double_tap" === this._config.lock.unlock, hasHold: "hold" === this._config.lock.unlock })}
          .config="${this._config}"
        >
    ...
    if (!t) throw new Error("Invalid configuration");const e = function () {
      ...
      let t = document.querySelector("hc-main");if (t = t && t.shadowRoot, t = t && t.querySelector("hc-lovelace"), t = t && t.shadowRoot, t = t && t.querySelector("hui-view"), t) {
        ...
        n = i.template,
        s = t.state;for (; n && e.config.button_card_templates && e.config.button_card_templates[n];) i = ye(e.config.button_card_templates[n], i), s = ve(e.config.button_card_templates[n].state, s), n = e.config.button_card_templates[n].template;i.state = s, this._config = Object.assign({ hold_action: { action: "none" }, double_tap_action: { action: "none" }, layout: "vertical", size: "40%", color_type: "icon", show_name: !0, show_state: !1, show_icon: !0, show_units: !0, show_label: !1, show_entity_picture: !1, show_live_stream: !1 }, i), this._config.entity && $t.has(ge(this._config.entity)) ? this._config = Object.assign({ tap_action: { action: "toggle" } }, this._config) : this._config = Object.assign({ tap_action: { action: "more-info" } }, this._config), this._config.lock = Object.assign({ enabled: !1, duration: 5, unlock: "tap" }, this._config.lock), this._config.default_color = "var(--primary-text-color)", "icon" !== this._config.color_type ? this._config.color_off = "var(--paper-card-background-color)" : this._config.color_off = "var(--paper-item-icon-color)", this._config.color_on = "var(--paper-item-icon-active-color)";const r = JSON.stringify(this._config),
          a = new RegExp(/states\[\s*('|\\")([a-zA-Z0-9_]+\.[a-zA-Z0-9_]+)\1\s*\]/, "gm"),
          o = new RegExp(/states\[\s*('|\\")([a-zA-Z0-9_]+\.[a-zA-Z0-9_]+)\1\s*\]/, "m"),
          l = r.match(a);this._entities = [], Array.isArray(this._config.triggers_update) && (this._entities = [...this._config.triggers_update]), null == l || l.forEach(t => {
      const e = t.match(o);e && !this._entities.includes(e[2]) && this._entities.push(e[2]);
    }), this._config.entity && !this._entities.includes(this._config.entity) && this._entities.push(this._config.entity);const c = new RegExp("\\[\\[\\[.*\\]\\]\\]", "gm");this._hasTemplate = !("all" !== this._config.triggers_update || !r.match(c));
  }getCardSize() {
    return 3;
  }_evalActions(t, e) {
...
};var Te;t([J()], ke.prototype, "_hass", void 0), t([J()], ke.prototype, "_config", void 0), t([J()], ke.prototype, "_timeRemaining", void 0), ke = t([(Te = "button-card", t => "function" == typeof t ? ((t, e) => (window.customElements.define(t, e), e))(Te, t) : ((t, e) => {
